...
var dictionary = {
    ...
    'text-about':{
        'es': 'Cuento con más de 2 años de experiencia como desarrollador Full Stack web y Android.'+ 
        ...
        'en': 'I have more than 2 years of experience as a Full Stack web and Android developer. '+ 
        'During my career I have been able to learn and improve skills that have helped me to build a specific profile. '+ 
        ' I have always had a great interest in learning new technologies and creating dynamic and intuitive user interfaces.'
    },
    'portfolio':{
...
function change_img(){
    ...
    if($('#list-cv').attr('href') === 'https://wilmerrojasbo.files.wordpress.com/2021/10/cv-wilmer-rojas-computer-engineer.pdf'){
